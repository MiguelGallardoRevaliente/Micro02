        ...
        <div class="estudiant">
            ...
            if(isset($_POST['mostrar'])){
                ...
                while($fila = mysqli_fetch_assoc($id_res)){
                    echo "<img src='data:" . $fila["tipus_foto"] . ";base64," . base64_encode($fila["foto_perfil"]) . "' alt='' style='max-width: 150px;'>";
                    echo "<div class='info'>";
        ...
        <div id="modificar">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="creacion">
                        ...
                        <br><div>
                            <label for="foto">FOTO DE PERFIL</label>
                            <input type="file" name="foto" accept="image/*" value="<?php echo $fila["foto_perfil"] ?>">
                        </div>
                    </div>
                    <br><br>
                    <div class="boton">
                        <button id="crear" name="modificar">MODIFICAR</button>
                    </div>
                </form>
            </div>
           <?php
